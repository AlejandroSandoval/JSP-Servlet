...
<html>
    ...
    <body>
       ...
       <div class="container">
           <h1><fmt:message key="label.TiTipo"/></h1>
           <div class=""><strong>${mensAler}</strong></div><br>
        <div class="row">
        <form name="TipoUsuaForm" id="TipoUsua" method="POST" action="TipoUsuaServ">
            <input type="hidden" name="codi_tipo" value="${codi_tipo}"/>
            <label for="nomb_tipo"><fmt:message key="label.Nomb"/></label>
            <input type="text" name="nomb_tipo" id="nomb_tipo" value="${nomb_tipo}"/><br/>
            <c:choose>
                <c:when test="${codi_tipo eq null}">
            ...
            <br/><br><br><br>
            <form method="POST" name="Frm" action="TipoUsuaServ">
        <% request.setAttribute( "demoAttr", new TipoUsuarioCtrl().consTodo()); %>
        <display:table id="TipoUsua" name="demoAttr" class="bordered highlight centered">
            <display:column property="nombTipoUsua" title="Tipo Usuario"sortable="true"/>
            <display:column title="Codigo" sortable="true">
                <input type="radio" name="codiRadioTipo" id="${TipoUsua.codiTipoUsua}" value="${TipoUsua.codiTipoUsua}"/><label for="${TipoUsua.codiTipoUsua}"></label>
            </display:column>
        </display:table>
            <br/>
            <div class="row">
